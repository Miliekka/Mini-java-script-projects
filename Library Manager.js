/**Программа для управления библиотекой. Она включает функции для отображения сведений о книгах,
 * получения краткое описание, фильтрации книг по автору и расчета общего количества страниц. 
 * Программа обрабатывает массив объектов книг, каждый из которых содержит свойства title , author , about и pages . */
const library = [
    {
