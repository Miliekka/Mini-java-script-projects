/** Эта программа  предоставляет набор функций для управления меню обеда, сохраненным в виде массива. 
Она позволяет добавлять, удалять и отображать элементы обеда, а также выбирать случайный элемент из меню.
Каждая функция возвращает обновленный массив или сообщение.
*/
const lunches = [];
